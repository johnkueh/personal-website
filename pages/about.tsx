          ...
          <HeaderWrapper>
            <Box mb={10} maxWidth={["100%", "100%", "100%", "768px"]}>
              ...
              <Text mt={5}>
                ...
                for more than 10 years. I build my own startups, and
                occasionally consult for others.
              </Text>

              <Text mt={5}>
                JavaScript (TypeScript) is my favourite programming language and
                I particularly enjoy working with these technologies:
              </Text>
              ...
              <Text mt={5}>
                ...
                <Link color="red.500" href="https://www.mishwong.com">
                  Michele
                </Link>
              ...
              <Text mt={5}>
                You can find me on&nbsp;
                <Link color="red.500" href="https://twitter.com/johnkueh">
                  Twitter
                </Link>
                &nbsp;where I talk about startups and development, or on&nbsp;
                <Link color="red.500" href="https://github.com/johnkueh">
                  GitHub
                </Link>
